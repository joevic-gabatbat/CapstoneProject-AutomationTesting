...
public class AndroidTabletBaseClass {
	
	public ExtentTest test;
	public static ExtentReports report;
	public static AndroidDriver driver;
	ConfigFileReader cfr = new ConfigFileReader();
	String jsonFilePath = cfr.getSpecificUrlProperties("androidTabletJSONPath");
	...
	public void beforeSuite() {
		test = CommonFunctions.generateExtentReports("Android Tablet");
	}
	...
	public void configureAppLaunch() throws FileNotFoundException, IOException, ParseException {
		...
		try {
			...
			test.log(LogStatus.INFO, "Launch MyBank Application on Android Tablet.");
		} catch (Exception e) {
			e.printStackTrace();
